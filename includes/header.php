...
<head>
    ...
    <title>ICT WORKSHOP - <?php echo $title ?></title>
        ...
        <div class=" container">
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container-fluid">
                    <a class="navbar-brand" href="index.php"><img src="img/ict.png" alt="Logo" width="190" height="64" class="d-inline-block align-text-top"></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item"><a class="nav-link text-primary" href="viewrecords.php">View Attendees</a></li>
                            </li>
                        </ul>
